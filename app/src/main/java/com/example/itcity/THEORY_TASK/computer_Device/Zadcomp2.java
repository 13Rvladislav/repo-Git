            ...
            public void onClick(View view) {
                switch (view.getId()) {
                    ...
                    case R.id.algTask2Button2:
                        bt2 = true;
                        DialogFragment singleChoiseDialog2 = new Comptask2SingleChoiceDialog();
                    ...
                    case R.id.algTask2Button3:
                        bt3 = true;
                        DialogFragment singleChoiseDialog3 = new Comptask2SingleChoiceDialog();
                    ...
                    case R.id.algCheck:
                        ...
                        if (TextUtils.isEmpty(answer1)) {
                            Toast toast = Toast.makeText(Zadcomp2.this, "вы не дали ответ в  поле 1", Toast.LENGTH_SHORT);
                            toast.show();
                            return;
                        }

                        if (TextUtils.isEmpty(answer2)) {
                            Toast toast = Toast.makeText(Zadcomp2.this, "вы не дали ответ в  поле 2", Toast.LENGTH_SHORT);
                            toast.show();
                            return;
                        }
                        if (TextUtils.isEmpty(answer3)) {
                            Toast toast = Toast.makeText(Zadcomp2.this, "вы не дали ответ в  поле 3", Toast.LENGTH_SHORT);
                            toast.show();
                            return;
                        }
                        ...
                        if (mark>50) {
                            dialog = new Dialog(Zadcomp2.this);
