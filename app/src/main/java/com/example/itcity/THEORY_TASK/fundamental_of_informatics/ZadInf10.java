...
public class ZadInf10 extends AppCompatActivity implements Inftask10SingleChoiceDialog.SingleChoiceListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View.OnClickListener onClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                switch (view.getId()) {
                    case R.id.button5:
                        Intent intent = new Intent(ZadInf10.this, ThInf10.class);
                        startActivity(intent);

                        break;
                    case R.id.algTask3Button1:
                        bt1 = true;
                        DialogFragment singleChoiseDialog1 = new Inftask10SingleChoiceDialog();
                    ...
                    case R.id.algTask3Button2:
                        bt2 = true;
                        DialogFragment singleChoiseDialog2 = new Inftask10SingleChoiceDialog();
                    ...
                    case R.id.algTask3Button4:
                        bt3 = true;
                        DialogFragment singleChoiseDialog3 = new Inftask10SingleChoiceDialog();
                    ...
                    case R.id.algCheck:
                        ...
                        if (TextUtils.isEmpty(answer1)) {
                            Toast toast = Toast.makeText(ZadInf10.this, "вы не дали ответ в  поле 1", Toast.LENGTH_SHORT);
                            toast.show();
                            return;
                        }

                        if (TextUtils.isEmpty(answer2)) {
                            Toast toast = Toast.makeText(ZadInf10.this, "вы не дали ответ в  поле 2", Toast.LENGTH_SHORT);
                            toast.show();
                            return;
                        }
                        if (TextUtils.isEmpty(answer3)) {
                            Toast toast = Toast.makeText(ZadInf10.this, "вы не дали ответ в  поле 3", Toast.LENGTH_SHORT);
                            toast.show();
                            return;
                        }
                        ...
                        if (mark > 50) {
                            dialog = new Dialog(ZadInf10.this);
                            ...
                            back_to_houses.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    Intent intent = new Intent(ZadInf10.this, Informatica_HOME.class);
                                    startActivity(intent);
                                }
                            });
