...
public class Sectask1SingleChoiceDialog extends DialogFragment {
    ...
    SingleChoiceListener mLisener;

    @Override
    public void onAttach(Context context) {
        super.onAttach(context);
        try {
            mLisener = (SingleChoiceListener) context;
        } catch (Exception e) {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        String[] list = getActivity().getResources().getStringArray(R.array.secchoice_items1);
