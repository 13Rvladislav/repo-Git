...
public class Zadp9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        answer1 = (EditText) findViewById(R.id.et);
            ...
            public void onClick(View view) {
                switch (view.getId()) {
                    case R.id.bottomSecurityK:
                        Intent intent1 = new Intent(Zadp9.this, Thpr9.class);
                        ...
                        if (mark >= 50) {
                            ...
                            back_to_houses.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    Intent intent = new Intent(Zadp9.this, Programming_Home.class);
