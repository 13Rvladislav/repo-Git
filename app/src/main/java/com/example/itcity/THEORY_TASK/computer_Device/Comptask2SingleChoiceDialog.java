...
public class Comptask2SingleChoiceDialog extends DialogFragment {
    ...
    Comptask2SingleChoiceDialog.SingleChoiceListener mLisener;

    @Override
    public void onAttach(Context context) {
        super.onAttach(context);
        try {
            mLisener = (Comptask2SingleChoiceDialog.SingleChoiceListener) context;
        } catch (Exception e) {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        String[] list = getActivity().getResources().getStringArray(R.array.compchoice_items2);
