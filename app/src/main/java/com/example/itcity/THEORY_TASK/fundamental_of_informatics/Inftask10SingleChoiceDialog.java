...
public class Inftask10SingleChoiceDialog extends DialogFragment {
    ...
    Inftask10SingleChoiceDialog.SingleChoiceListener mLisener;

    @Override
    public void onAttach(Context context) {
        super.onAttach(context);
        try {
            mLisener = (Inftask10SingleChoiceDialog.SingleChoiceListener) context;
        } catch (Exception e) {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        String[] list = getActivity().getResources().getStringArray(R.array.infchoice_items10);
