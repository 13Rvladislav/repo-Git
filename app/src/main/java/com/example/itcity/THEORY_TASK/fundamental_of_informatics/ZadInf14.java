...
public class ZadInf14 extends AppCompatActivity {
    Button next;
    Button back;
    EditText answer1;
    int mark;
                        ...
                        if (mark > 50) {
                            ...
                            back_to_houses.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    Intent intent = new Intent(ZadInf14.this, Informatica_HOME.class);
