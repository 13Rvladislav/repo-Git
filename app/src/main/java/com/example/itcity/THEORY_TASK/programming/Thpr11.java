...
public class Thpr11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.progtheory11);
            ...
            public void onClick(View view) {
                switch (view.getId()) {
                    case R.id.bottomSecurityK:
                        Intent intent2 = new Intent(Thpr11.this, Programming_Home.class);
                        startActivity(intent2);
                        break;
                    case R.id.continueSec:
                        Intent intent1 = new Intent(Thpr11.this, Zadp11.class);
