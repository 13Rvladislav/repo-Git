...
public class ZadInf11 extends AppCompatActivity {
    Button next;
    Button back;
    EditText answer1;
    int mark;
            ...
            public void onClick(View view) {
                switch (view.getId()) {
                    case R.id.bottomTeoryK1:
                        Intent intent1 = new Intent(ZadInf11.this, ThInf11.class);
                    ...
                    case R.id.algCheck:
                        ...
                        if (mark > 50) {
                            dialog = new Dialog(ZadInf11.this);
                            ...
                            back_to_houses.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    Intent intent = new Intent(ZadInf11.this, Informatica_HOME.class);
