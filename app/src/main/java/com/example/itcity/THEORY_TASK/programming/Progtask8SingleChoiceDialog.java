...
public class Progtask8SingleChoiceDialog extends DialogFragment {
    ...
    Progtask8SingleChoiceDialog.SingleChoiceListener mLisener;

    @Override
    public void onAttach(Context context) {
        super.onAttach(context);
        try {
            mLisener = (Progtask8SingleChoiceDialog.SingleChoiceListener) context;
        } catch (Exception e) {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        String[] list = getActivity().getResources().getStringArray(R.array.progchoice_items8);
