...
public class ThInf16 extends AppCompatActivity {
    Button button8;
    Button back;
    @Override
            ...
            public void onClick(View view) {
                switch (view.getId()) {
                    case R.id.bottomTeoryK1:
                        Intent intent1 = new Intent(ThInf16.this,Informatica_HOME.class);
                        startActivity(intent1);
                        break;
                    case R.id.button8:
                        Intent intent = new Intent(ThInf16.this,ZadInf15.class);
