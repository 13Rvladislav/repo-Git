...
public class Progtask3SingleChoiceDialog  extends DialogFragment {
...
public interface SingleChoiceListener {
    ...
    Progtask3SingleChoiceDialog.SingleChoiceListener mLisener;

    @Override
    public void onAttach(Context context) {
        super.onAttach(context);
        try {
            mLisener = (Progtask3SingleChoiceDialog.SingleChoiceListener) context;
        } catch (Exception e) {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        String[] list = getActivity().getResources().getStringArray(R.array.progchoice_items3);
