...
public class Thpr13 extends AppCompatActivity {
            ...
            public void onClick(View view) {
                switch (view.getId()) {
                    case R.id.bottomSecurityK:
                        Intent intent2 = new Intent(Thpr13.this, Programming_Teory_Task.class);
                        startActivity(intent2);
                        break;
                    case R.id.continueSec:
                        Intent intent1 = new Intent(Thpr13.this, Zadprog7.class);
