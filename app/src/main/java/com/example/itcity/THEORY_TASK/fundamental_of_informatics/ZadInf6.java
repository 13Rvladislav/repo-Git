...
public class ZadInf6 extends AppCompatActivity {
    Button next;
    Button back;
    EditText answer1;
    int mark;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.inftask6);
            ...
            public void onClick(View view) {
                switch (view.getId()) {
                    ...
                    case R.id.algCheck:
                        ...
                        if ((ans1.equalsIgnoreCase("3db"))) {
                            mark += 100;
                        }
                        String markSTR;
                        //вызов диалогового окна с показом количества баллов
                        if (mark > 50) {
                            dialog = new Dialog(ZadInf6.this);
                            ...
                            back_to_houses.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    Intent intent = new Intent(ZadInf6.this, Informatica_HOME.class);
