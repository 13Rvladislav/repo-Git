...
public class ThInf12 extends AppCompatActivity {
    Button button8;
    Button back;
    @Override
            ...
            public void onClick(View view) {
                switch (view.getId()) {
                    case R.id.bottomTeoryK1:
                        Intent intent1 = new Intent(ThInf12.this,Informatica_HOME.class);
                        startActivity(intent1);
                        break;
                    case R.id.button8:
                        Intent intent = new Intent(ThInf12.this,ZadInf12.class);
