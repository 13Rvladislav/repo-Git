...
public class ZadInf4 extends AppCompatActivity {
    Button next;
    Button back;
    EditText answer1;
    int mark;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.inftask4);
            ...
            public void onClick(View view) {
                switch (view.getId()) {
                    case R.id.bottomTeoryK1:
                        Intent intent1 = new Intent(ZadInf4.this, Tinf4.class);
                        startActivity(intent1);
                        break;
                    case R.id.algCheck:
                        String ans1 = answer1.getText().toString();
                        ans1 = ans1.toLowerCase();
                        if ((ans1.equalsIgnoreCase("1011001"))) {
                            mark += 100;
                        }
                        String markSTR;
                        //вызов диалогового окна с показом количества баллов
                        if (mark > 50) {
                            dialog = new Dialog(ZadInf4.this);
                            ...
                            back_to_houses.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    Intent intent = new Intent(ZadInf4.this, Informatica_HOME.class);
